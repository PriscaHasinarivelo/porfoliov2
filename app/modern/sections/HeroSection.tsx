    ...
    <section className="section-panel flex items-center justify-center px-4 sm:px-8 lg:px-16 pt-16 sm:pt-20">
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        >
          ...
          <motion.p
            className="text-white/60 text-base sm:text-lg max-w-md"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <button 
              ...
              className="btn-modern flex items-center gap-2 group text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3"
            >
              {t('hero.discover')}
            ...
            <button 
              ...
              className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-[#ffa101] flex items-center justify-center text-[#ffa101] hover:bg-[#ffa101] hover:text-[#31525b] transition-all"
            >
          ...
          >
            <span className="text-white/40 text-xs sm:text-sm hidden sm:block">{t('hero.followMe')}</span>
            <div className="flex gap-2 sm:gap-3">
              <a 
                href="https://github.com/PriscaHasinarivelo/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="social-icon-modern w-10 h-10 sm:w-12 sm:h-12" 
                aria-label="GitHub"
              >
        ...
        <motion.div
          className="relative flex items-center justify-center mt-8 lg:mt-0 order-first lg:order-last"
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center hidden lg:flex">
            <motion.div
              className="w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] lg:w-[500px] lg:h-[500px] rounded-full border-2 border-dashed border-[#ffa101]/20"
              animate={{ rotate: 360 }}
              transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
            />
            <motion.div
              className="absolute w-[240px] h-[240px] sm:w-[320px] sm:h-[320px] lg:w-[400px] lg:h-[400px] rounded-full border border-[#fae6b1]/10"
              animate={{ rotate: -360 }}
              transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
            />
            <motion.div
              className="absolute w-[180px] h-[180px] sm:w-[240px] sm:h-[240px] lg:w-[300px] lg:h-[300px] rounded-full border border-[#b3dee5]/10"
              animate={{ rotate: 360 }}
          ...
          {/* Orbiting Stats - Repositioned for mobile */}
          {/* Card 1: Top-left - Major Complex Projects */}
          <motion.div
            className="absolute -top-2 -left-2 sm:top-0 sm:left-0 lg:top-4 lg:-left-4 stat-card scale-75 sm:scale-90 lg:scale-100"
            animate={{ 
              y: [0, -12, 0],
              rotate: [0, 4, 0],
              x: [0, 6, 0],
          ...
          <motion.div
            className="absolute -bottom-2 -left-2 sm:bottom-4 sm:left-0 lg:bottom-16 lg:-left-2 stat-card scale-75 sm:scale-90 lg:scale-100"
            animate={{ 
              y: [0, 10, 0],
              rotate: [0, -3, 0],
              x: [0, -5, 0],
          ...
          <motion.div
            className="absolute top-1/2 -translate-y-1/2 -right-2 sm:right-0 lg:right-8 stat-card scale-75 sm:scale-90 lg:scale-100"
            animate={{ 
              y: [0, -8, 0],
              rotate: [0, 2, 0],
              x: [0, 4, 0],
          ...
          {/* Floating shapes near photo - Hidden on small mobile */}
          <motion.div
            className="absolute -bottom-4 -left-4 w-12 h-12 sm:w-16 sm:h-16 rounded-lg bg-[#ffa101]/20 rotate-12 hidden sm:block"
            animate={{ 
              rotate: [12, 25, 12],
              scale: [1, 1.1, 1],
            }}
          ...
          />
          <motion.div
            className="absolute top-0 -left-6 sm:-left-8 w-6 h-6 sm:w-8 sm:h-8 rounded-full border-2 border-[#fae6b1]/40 hidden sm:block"
            animate={{ 
              y: [0, -15, 0],
              x: [0, 10, 0],
            }}
