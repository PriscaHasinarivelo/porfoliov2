    ...
    <section className="section-panel flex items-center justify-center px-8 lg:px-16 pt-20">
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            {lang === 'en' ? t('hero.im') : ''} <span className="gradient-text-orange">Prisca</span>
            <br />
            {t('hero.role')}
            <br />
          ...
          >
            <button className="btn-modern flex items-center gap-2 group">
              {t('hero.discover')}
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="w-12 h-12 rounded-full border-2 border-[#ffa101] flex items-center justify-center text-[#ffa101] hover:bg-[#ffa101] hover:text-[#31525b] transition-all">
          ...
          >
            ...
            <div className="flex gap-3">
              <a href="#" className="social-icon-modern" aria-label="Web">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>
              </a>
              <a href="#" className="social-icon-modern" aria-label="GitHub">
              ...
              <a href="#" className="social-icon-modern" aria-label="LinkedIn">
        ...
        >
          ...
          {/* Orbiting Stats */}
          {/* Card 1: Top-left area - closer */}
          <motion.div
            className="absolute top-4 left-4 lg:top-8 lg:left-0 stat-card"
            animate={{ 
              y: [0, -12, 0],
              rotate: [0, 4, 0],
              x: [0, 6, 0],
          ...
          >
            <div className="text-3xl font-bold text-[#ffa101]">45+</div>
            <div className="text-xs text-white/60">{t('stats.clients')}</div>
          </motion.div>

          {/* Card 2: Bottom-left area - closer */}
          <motion.div
            className="absolute bottom-20 left-0 lg:bottom-24 lg:left-4 stat-card"
            animate={{ 
              y: [0, 10, 0],
              rotate: [0, -3, 0],
              x: [0, -5, 0],
          ...
          >
            <div className="text-3xl font-bold text-[#ffa101]">320</div>
            <div className="text-xs text-white/60">{t('stats.projects')}</div>
          </motion.div>

          {/* Card 3: Right side centered - closer */}
          <motion.div
          ...
          >
            ...
            <div className="text-2xl font-bold text-[#ffa101]">5 {lang === 'fr' ? 'Ans' : 'Years'}</div>
